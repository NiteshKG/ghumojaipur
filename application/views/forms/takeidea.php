...
<body>
  ...
  <form action="<?php echo base_url().'index.php/user/takeidea/'; ?>" method="post" name="registerform">
  <div class="card-body">
	...
	<div class="form-group">
		<label for="name"><b>Your Idea</b></label>
		<input type="text" name="youridea" id="youridea" value="<?php echo set_value(field : 'youridea') ?>" class="form-control" placeholder="Drop your idea here">
		<label for=""><?php echo form_error('youridea')? form_error('youridea') : '' ;?></label>
	</div>
